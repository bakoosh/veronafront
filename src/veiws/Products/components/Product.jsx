            ...
            <div className="pt-5">
                <div className="flex items-center justify-between px-3">
                    ...
                    <div className="flex">
                        ...
                        <svg onClick={() => handleBasketClick(product.id)} className="w-6 h-6 text-gray-600 ml-3 hover:cursor-pointer  transition-transform duration-300 transform hover:scale-125" viewBox="0 0 77.18 72.55">
                            <g>
                ...
                <div className="w-full">
                    ...
                    <h1 className="ml-3 text-xl flex items-start">{product.sample} пробы</h1>
